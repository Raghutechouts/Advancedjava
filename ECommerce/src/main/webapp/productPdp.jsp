...
<jsp:setProperty name="u" property="productName" />
<!DOCTYPE html>
<html>
<head>
...
<%
	...
	List<ProductDetails> list = ProductDao.getProductDataPdp(name);
		...
		<c:forEach items="${mylist}" var="data">
			...
			<div class="a">
				...
				<div style="text-align:justify; ;font-weight: 700;">
					...
					<p >About Product: ${data.getProductDesc()}</p>
				</div>
				<div style="display: grid;">
					...
					<button class="buttons" type="button">
						<a  style="color: black; text-align: center; padding: 12px; text-decoration: none" href="home.html">CANCLE</a>
					</button>
				</div>
			</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </c:forEach>
