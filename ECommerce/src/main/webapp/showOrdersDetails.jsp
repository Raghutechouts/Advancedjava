...
<body>
	...
	List<ProductDetails> list = CartDao.getOrderData(username);
	if(list.isEmpty()){
		response.sendRedirect("orderEmpty.jsp");
	}
		...
		<c:forEach items="${mylist}" var="data">
			...
			<div class="a">
				...
				<div style="display: grid;">
					...
					<button class="buttons" type="button">
						<a href="deletefromorders.jsp?name=${data.getProductName()}">CANCLE ORDER</a>
					</button>
				</div>
			</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </c:forEach>
