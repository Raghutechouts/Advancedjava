...
<body>
	<header>
		<div class="header">
			...
			<ul class="header-right">
				<a
					style="color: black; text-align: center; padding: 12px; text-decoration: none;"
					href="home.html"> <span>Home</span></a>
				<a
					style="color: black; text-align: center; padding: 12px; text-decoration: none;"
	...
	List<ProductDetails> list = CartDao.getCartData(username);
	if(list.isEmpty()){
		...
		<c:forEach items="${mylist}" var="data">
			...
			<div class="a">
				<a href="productPdp.jsp?name=${data.getProductName()}"><img
					id="shirtsid" alt="image" src="${data.getUrl()}"></a>
				...
				<div style="display: grid;">
					<button class="buttons" type="button">
						<a href="checkout.jsp?name=${data.getProductName()}">CHECK OUT</a>
					</button>
					<button class="buttons" type="button">
						<a href="deletefromcart.jsp?name=${data.getProductName()}">REMOVE
							FROM CART</a>
					</button>
				</div>
			</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
